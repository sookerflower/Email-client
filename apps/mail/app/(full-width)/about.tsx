...
const sections = [
  {
    ...
    content: (
      <p>
        AxMail is an AI-powered email client that manages your inbox, so you don't have to. We help
  ...
  },
  {
    ...
    content: (
      <p>
        We started AxMail because we were frustrated that email — the most-used communication tool in
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          We launched our early access program and have already seen strong demand. What we found is that users want an assistant that
        ...
        <p>
          ...
          it manually. AxMail is poised to fundamentally change the way the world deals with
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          The cofounders of AxMail met through shared passion for privacy and modern web software. Coming from
  ...
  },
  {
    ...
    content: (
      <div className="space-y-3">
        <p>Want to learn more about AxMail? Get in touch:</p>
