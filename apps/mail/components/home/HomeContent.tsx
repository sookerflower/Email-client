  ...
  return (
    <main className="relative flex h-full flex-1 flex-col overflow-x-hidden bg-[#0F0F0F] px-2">
      ...
      <section className="z-10 mt-32 flex flex-col items-center px-4">
        ...
        >
          AxMail is an AI-native email client that manages your inbox, so you don't have to.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <span className="flex items-center gap-2 text-sm">Self-hosted. Private by design.</span>
        </motion.div>
